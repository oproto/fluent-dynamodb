...
public class FormatStringExamples
{
    ...
    public FormatStringExamples(IDynamoDbTable table, FluentDynamoDbOptions? options = null)
    {
        _table = table;
        _options = options ?? new FluentDynamoDbOptions();
    }

    // Helper methods to create request builders (these would be generated by source generator in real usage)
    private Requests.QueryRequestBuilder<TEntity> Query<TEntity>() where TEntity : class, IReadOnlyEntity
        => new Requests.QueryRequestBuilder<TEntity>(_table.DynamoDbClient, _options).ForTable(_table.Name);

    private Requests.UpdateItemRequestBuilder<TEntity> Update<TEntity>() where TEntity : class, IDynamoDbEntity
        => new Requests.UpdateItemRequestBuilder<TEntity>(_table.DynamoDbClient, _options).ForTable(_table.Name);

    private Requests.DeleteItemRequestBuilder<TEntity> Delete<TEntity>() where TEntity : class, IDynamoDbEntity
        => new Requests.DeleteItemRequestBuilder<TEntity>(_table.DynamoDbClient, _options).ForTable(_table.Name);

    private Requests.PutItemRequestBuilder<TEntity> Put<TEntity>() where TEntity : class, IDynamoDbEntity
        => new Requests.PutItemRequestBuilder<TEntity>(_table.DynamoDbClient, _options).ForTable(_table.Name);
    ...
    public async Task BasicQueryExample()
    {
        ...
        var oldResult = await Query<ExampleEntity>()
        ...
        var newResult = await Query<ExampleEntity>()
    ...
    public async Task DateTimeFormattingExample()
    {
        ...
        var result = await Query<ExampleEntity>()
    ...
    public async Task FilterExpressionFormatStringExamples()
    {
        ...
        var result1 = await Query<ExampleEntity>()
            .Where("pk = {0}", userId)
        ...
        var result2 = await Query<ExampleEntity>()
            .Where("pk = {0}", userId)
        ...
        var result3 = await Query<ExampleEntity>()
            .Where("pk = {0}", userId)
        ...
        var result4 = await Query<ExampleEntity>()
            .Where("pk = {0}", userId)
        ...
        var result5 = await Query<ExampleEntity>()
            .Where("pk = {0}", userId)
