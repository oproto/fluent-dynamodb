...
/// - S2IndexFine property (index accessor) from [GsiPartitionKey("s2-index-fine")]
/// - S2IndexMedium property (index accessor) from [GsiPartitionKey("s2-index-medium")]
/// - S2IndexCoarse property (index accessor) from [GsiPartitionKey("s2-index-coarse")]
/// </summary>
/// <remarks>
/// <para>
...
/// </list>
/// </remarks>
public partial class StoresS2Table
{
    ...
    // [GsiPartitionKey] attributes on StoreS2 location properties:
