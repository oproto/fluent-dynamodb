...
- [ ] 1. Fix IsMultiItemEntity flag in EntityAnalyzer
  - [ ] 1.1 Update EntityAnalyzer to set IsMultiItemEntity based on relationships
  ...
  - [ ] 1.2 Write property test for IsMultiItemEntity flag
  ...
  - [ ] 1.3 Write unit tests for IsMultiItemEntity flag
...
- [ ] 2. Fix wildcard pattern matching in MapperGenerator
  - [ ] 2.1 Update GenerateSortKeyPatternMatching for multi-segment wildcards
  ...
  - [ ] 2.2 Write property test for wildcard pattern matching
  ...
  - [ ] 2.3 Write unit tests for pattern matching edge cases
...
- [ ] 3. Fix primary entity identification in GenerateMultiItemFromDynamoDb
  - [ ] 3.1 Update GenerateMultiItemFromDynamoDb to identify primary entity item
    - Modify `Oproto.FluentDynamoDb.SourceGenerator/Generators/MapperGenerator.cs`
  ...
  - [ ] 3.2 Write property test for primary entity identification
...
- [ ] 4. Checkpoint - Verify source generator changes
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Update InvoiceManager property tests to use ToCompositeEntityAsync directly
  - [ ] 5.1 Update GetCompleteInvoiceAsync to use ToCompositeEntityAsync
  ...
  - [ ] 5.2 Write property test for composite entity assembly
...
- [ ] 6. Add edge case handling
  - [ ] 6.1 Handle case when no primary entity item is found
    - Ensure `FromDynamoDb` returns null or throws appropriate exception when no primary entity item matches
    - _Requirements: 2.3_

  - [ ] 6.2 Write unit test for null return when no primary entity
